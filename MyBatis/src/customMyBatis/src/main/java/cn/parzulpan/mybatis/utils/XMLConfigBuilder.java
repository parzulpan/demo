...
import cn.parzulpan.mybatis.annotations.Select;
...
import cn.parzulpan.mybatis.session.impl.SqlSessionImpl;
...
public class XMLConfigBuilder {
     ...
     * 使用的技术：dom4j + xpath
     */
    public static Configuration loadConfiguration(SqlSessionImpl session, InputStream is) {
        try {
            ...
            for (Element mapperElement : mapperElements) {
                ...
                if (attribute != null) {
                    ...
                    // 取出属性的值
                    String mapperPath = attribute.getValue();   // 获取属性的值 "cn/parzulpan/dao/UserDAO.xml"
